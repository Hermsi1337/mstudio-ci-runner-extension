...
docker/builder/              image builder service: Dockerfile, loop.sh, sandbox.sh (emulated builds), kaniko and qemu versions, kaniko patches (build context is docker/builder)
