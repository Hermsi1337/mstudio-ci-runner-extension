...
| `RUNNER_DATA_DIR` | Persistent state, mount point of the `runner-data` volume | `/home/runner/data` |
...
Volumes: `runner-data:/home/runner/data`, optionally `tool-cache:/home/runner/.cache`
(see [Volumes](#volumes)).
...
not inside the container. Volumes: `runner-data:/home/runner/data`, optionally
`tool-cache:/home/runner/.cache` (see [Volumes](#volumes)).

## Volumes

Every runner gets exactly one volume, `runner-data`, mounted at `/home/runner/data`.
...
|---|---|---|---|
| `runner-data` | `/home/runner/data` | GitHub: `config/` (registration), `work/` (checkouts, actions, tool cache). GitLab: `builds/`, `cache/` | always |
| `tool-cache` | `/home/runner/.cache` | Package manager caches, trimmed by a cronjob ([providers.md](providers.md#package-manager-cache)) | cache enabled |
