...
// Docker-style random container name generator.
// Names are combinations of adjectives and notable scientists/hackers.
// This mirrors the behavior of github.com/moby/moby/pkg/namesgenerator
...
var (
	...
	// Notable scientists, hackers, and other luminaries
	right = []string{
		...
		"hypatia", "ishizaka", "jackson", "jang", "jemison",
		...
		"mcclintock", "mclaren", "mclean", "mcnulty", "meitner",
		"mendel", "mendeleev", "meninsky", "merkle", "mestorf",
